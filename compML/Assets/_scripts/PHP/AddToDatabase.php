<?php
	...
	*/
    ...
    $insert   = "INSERT INTO $table (`id`, `name`, `filenameImg`, `scoreBoundsBalance`, `scorePixelsBalance`, `scoreUnityVisual`) VALUES (NULL, '$name', '$filenameImg', '$scoreBoundsBalance', '$scorePixelsBalance' , '$scoreUnityVisual')";
