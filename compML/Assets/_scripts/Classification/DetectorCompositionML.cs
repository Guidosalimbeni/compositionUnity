...
public class DetectorCompositionML : MonoBehaviour
{
    ...
    public DetectorCompositionML(TextAsset modelFile,
                    TextAsset labelFile,
                        ...
                        int angle = 0, Flip flip = Flip.NONE)
    {
        ...
        {
            float[] imgData = UtilsCompositionML.DecodeTexture(texture, _inputWidth, _inputHeight,
        ...
        {
            byte[] imgData = UtilsCompositionML.DecodeTexture(texture, _inputWidth, _inputHeight, angle, flip);
            inputTensor = TFTensor.FromBuffer(shape, imgData, 0, imgData.Length);
        }
        else
        {
