...
public class ClassificationFinalOut : MonoBehaviour
{
    ...
    public ClassificationFinalOut(TextAsset modelFile,

                      string input = "input",
                      string output = "output",
                      int input_dimension = 3)
    {
#if UNITY_ANDROID
    ...
    public float PredictFinalOutScore(float[] data)
    {
        ...
        float scoreFinalOut = outputs[0, 0];
        inputTensor.Dispose();
        output.Dispose();

        return scoreFinalOut;
    }
